 ...
 * @extends WC_Email
 */
class ENR_Email_Customer_Manual_Renewal_Reminder extends WC_Email {
	...
	public function __construct() {
		...
		add_action( 'enr_wc_subscriptions_remind_before_manual_renewal_notification', array( $this, 'trigger' ) ) ;
